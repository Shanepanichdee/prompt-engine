    ...
    <div className="signin-page">
      <div className="signin-card">
        <div className="signin-header">
          <div className="signin-logo">PE</div>
          <h1 className="signin-title">Sign in to Prompt Engine</h1>
        </div>
        ...
        {sent ? (
          <p className="signin-sent">Check your email — we sent a sign-in link to <strong>{email}</strong>.</p>
        ) : (
